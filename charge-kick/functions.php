...
$functions = array(
    'ability_function' => function($objects){
        ...
        $this_ability->damage_options_update(array(
            ...
            'success' => array(1, -35, 0, 10, 'The '.$this_ability->print_name().' crashes into the target!'),
        ...
        rpg_ability::ability_function_stat_break($this_robot, 'speed', 1, $this_ability);
