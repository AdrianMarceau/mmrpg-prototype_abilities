...
$functions = array(
    'ability_function' => function($objects){
        ...
        $this_ability->target_options_update(array(
            'frame' => 'throw',
            'success' => array(0, 95, 0, 10, $this_robot->print_name().' uses the '.$this_ability->print_name().'!')
            ));
        ...
        if ($target_player->counters['robots_positions']['bench'] >= 2){
            ...
            $this_ability->damage_options_update(array(
                'kind' => 'energy',
                'kickback' => array(30, 30, 0),
                'success' => array(1, 15, 15, 10, 'The '.$this_ability->print_name().' struck the target!'),
                'failure' => array(1, -60, 80, 10, 'The '.$this_ability->print_name().' bounced straight past the target&hellip;')
                ));
            $this_ability->recovery_options_update(array(
                'kind' => 'energy',
                'frame' => 'taunt',
                'kickback' => array(10, 0, 0),
                'success' => array(3, 15, 15, 10, 'The momentum of the '.$this_ability->print_name().' only made the target stronger!'),
                'failure' => array(1, -65, -15, 10, 'The '.$this_ability->print_name().' bounced straight past the target&hellip;')
                ));
            ...
            if ($temp_second_target_robot->robot_energy > 0){
                ...
                $this_ability->damage_options_update(array(
                    'kind' => 'energy',
                    'kickback' => array(-5, 30, 0),
                    'success' => array(2, -15, -15, 10, 'The other '.$this_ability->print_name().' struck another robot!'),
                    'failure' => array(1, -75, -15, -10, 'The '.$this_ability->print_name().' bounced straight past the target&hellip;')
                    ));
                $this_ability->recovery_options_update(array(
                    'kind' => 'energy',
                    'frame' => 'taunt',
                    'kickback' => array(-5, 0, 0),
                    'success' => array(4, -15, -15, -10, 'The momentum of the '.$this_ability->print_name().' only made the target stronger!'),
                ...
                if ($this_ability->ability_results['this_result'] != 'failure'){ $num_hits_counter++; }
                    ...
                    rpg_ability::ability_function_stat_boost($this_robot, 'attack', 2, $this_ability, array(
        ...
        // Otherwise ability will automatically target ACTIVE robot or LONE BENCHED robot
            ...
            $this_ability->damage_options_update(array(
                'kind' => 'energy',
                'kickback' => array(10, 20, 0),
                'success' => array(4, 15, -10, 10, 'The '.$this_ability->print_name().' struck the target!'),
                'failure' => array(1, -60, -10, 10, 'The '.$this_ability->print_name().' completely soared past the target&hellip;')
                ));
            $this_ability->recovery_options_update(array(
                'kind' => 'energy',
                'frame' => 'taunt',
                'kickback' => array(10, 0, 0),
                'success' => array(4, 15, -15, 10, 'The '.$this_ability->print_name().' just made the target stronger!'),
            ...
            if ($temp_target_robot->robot_status != 'disabled'
                ...
                $this_ability->damage_options_update(array(
                    'kind' => 'energy',
                    'kickback' => array(-10, 40, 0),
                    'success' => array(4, -15, -15, 10, 'The '.$this_ability->print_name().' struck the target'.($num_hits_counter > 0 ? ' again' : '').'!'),
                    'failure' => array(1, -75, -15, -10, 'The '.$this_ability->print_name().' missed the target&hellip;')
                    ));
                $this_ability->recovery_options_update(array(
                    'kind' => 'energy',
                    'frame' => 'taunt',
                    'kickback' => array(-10, 0, 0),
                    'success' => array(4, -15, -15, -10, 'The '.$this_ability->print_name().' made the target stronger'.($num_hits_counter > 0 ? ' again' : '').'!'),
                    'failure' => array(1, -75, -15, -10, 'The '.$this_ability->print_name().' missed the target&hellip;')
                    ));
                $energy_damage_amount = $this_ability->ability_damage2;
                $temp_target_robot->trigger_damage($this_robot, $this_ability, $energy_damage_amount, false);
