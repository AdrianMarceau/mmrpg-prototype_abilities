    ...
    'ability_function' => function($objects){
        ...
        if ($this_ability->ability_results['this_result'] != 'failure'){
            ...
            $this_ability->damage_options_update(array(
                ...
                'type' => '',
                'frame' => 'damage',
                'success' => array(6, -9999, 5, -10, 'The '.$this_robot->print_name().' was damaged by the collision!'),
                'failure' => array(6, -9999, 5, -10, $this_robot->print_name().' somehow survived the collision&hellip;')
                ));
            $energy_damage_amount = ceil($this_robot->robot_base_energy / 3);
