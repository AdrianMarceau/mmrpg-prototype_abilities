...
$functions = array(
    'ability_function' => function($objects){
        ...
        // Check to see which stat is worst for this robot, best for the target
        ...
        $this_ability->target_options_update(array(
            ...
            'success' => array(0, 0, 0, -10,
                ...
                ucfirst($this_robot->get_pronoun('subject')).' triggered a '.$this_ability->print_name().' on '.$target_robot->print_name().'!'
                )
            ));
        ...
        $boost_amount = $break_amount * -1;
        //if ($boost_amount > MMRPG_SETTINGS_STATS_MOD_MAX){ $boost_amount = MMRPG_SETTINGS_STATS_MOD_MAX; }
        ...
        if ($this_robot->robot_core !== 'empty'){
            ...
            $this_ability->damage_options_update(array(
                ...
                'type' => '',
                'frame' => 'damage',
                'success' => array(6, -9999, 5, -10, 'The '.$this_ability->print_name().' pushed '.$this_robot->print_name_s().' health to the brink!'),
                'failure' => array(6, -9999, 5, -10, $this_robot->print_name().' somehow survived the '.$this_ability->print_name().'&hellip;')
                ));
            $energy_damage_amount = $this_robot->robot_energy - 1;
