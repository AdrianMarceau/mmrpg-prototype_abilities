...
$functions = array(
    'ability_function' => function($objects){
        ...
        if (mt_rand(0, 1) == 0){
            ...
            rpg_ability::ability_function_stat_boost($this_robot, 'attack', mt_rand(1, 10), $this_ability);

        } else {

            // Call the global stat break function with customized options
            rpg_ability::ability_function_stat_break($target_robot, 'attack', mt_rand(1, 10), $this_ability, array(
