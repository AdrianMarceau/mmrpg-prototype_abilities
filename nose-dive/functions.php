...
$functions = array(
  'ability_function' => function($objects){
    ...
    $this_ability->target_options_update(array(
      ...
      'success' => array($this_frames['target'], 250, 160, 30, $this_robot->print_name().' uses the '.$this_ability->print_name().'!')
      ));
    ...
    $this_ability->damage_options_update(array(
      ...
      'success' => array($this_frames['impact'], 0, -20, 30, 'The '.$this_ability->print_name().' dashed through the target!'),
      'failure' => array($this_frames['impact'], 0, -50, 30, 'The '.$this_ability->print_name().' missed&hellip;')
      ));
