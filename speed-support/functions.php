...
$functions = array(
    'ability_function' => function($objects){
        ...
        rpg_ability::ability_function_stat_boost($this_robot, 'speed', $this_ability->ability_recovery2, $this_ability);
        ...
        if ($backup_robots_active_count > 0){
            ...
            foreach ($backup_robots_active AS $key => $info){
                ...
                rpg_ability::ability_function_stat_boost($temp_this_robot, 'speed', $this_ability->ability_recovery2, $this_ability, array(
