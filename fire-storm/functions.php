...
$functions = array(
    'ability_function' => function($objects){
        ...
        if ($shot_power >= 2){ $this_battle->queue_sound_effect(array('name' => 'flame-sound', 'delay' => 100)); }
        if ($shot_power >= 3){ $this_battle->queue_sound_effect(array('name' => 'flame-sound', 'delay' => 200)); }
        ...
        if ($shot_power >= 3
            ...
            rpg_ability::ability_function_stat_boost($this_robot, 'defense', 3, $this_ability);
