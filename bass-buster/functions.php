...
$functions = array(
    'ability_function' => function($objects){
        ...
        if (!$is_charged){
            ...
            $this_battle->queue_sound_effect(array('name' => 'charge-sound', 'volume' => 0.8, 'delay' => 120));
            $this_battle->queue_sound_effect(array('name' => 'charge-sound', 'volume' => 1.0, 'delay' => 240));
        ...
        // Else if the ability flag was set, the ability is released at the target
            ...
            $this_battle->queue_sound_effect(array('name' => 'blast-sound', 'volume' => 0.8, 'delay' => 60));
            $this_battle->queue_sound_effect(array('name' => 'blast-sound', 'volume' => 0.6, 'delay' => 120));
            $this_ability->target_options_update(array(
                'frame' => 'shoot',
