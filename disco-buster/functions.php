    ...
    'ability_function' => function($objects){
        ...
        if (!$is_charged){
            ...
            $trigger_options['event_flag_sound_effects'] = array(
                ...
                array('name' => 'charge-sound', 'volume' => 1.4, 'delay' => 115),
                array('name' => 'charge-sound', 'volume' => 1.6, 'delay' => 235),
                );
        ...
        // Else if the ability flag was set, the ability is released at the target
            ...
            if ($target_robot->robot_status != 'disabled'
                ...
                rpg_ability::ability_function_stat_break($target_robot, 'attack', 3, array(
